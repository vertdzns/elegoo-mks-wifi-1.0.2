...
class SaveOutputDevice(OutputDevice):
    ...
    def save_gcode(self, file_name, _gcode):
        ...
        try:
            ...
            if image and(machineType == "elegoo_neptune_3_pro" or machineType == "elegoo_neptune_3_plus"):
                save_file.write(utils.add_screenshot_new(image, 200, 200, ";gimage:"))
                save_file.write(utils.add_screenshot_new(image, 160, 160, ";simage:"))
                # save_file.write(utils.add_screenshot(image, 200, 200, ";;gimage:"))
                save_file.write("\r")
            elif image and machineType != "elegoo_neptune_3":
