...
class MKSOutputDevice(NetworkedPrinterOutputDevice):
    ...
    def _startPrint(self, file_name="cura_file.gcode"):
        ...
        try:
            ...
            Logger.log("d", "mks: save--getId---" + machineType)

            single_string_file_data = ""
            if self._screenShot and (machineType == "elegoo_neptune_3_pro" or machineType == "elegoo_neptune_3_plus"):
                single_string_file_data += utils.add_screenshot_new(self._screenShot, 200, 200, ";gimage:")
                single_string_file_data += utils.add_screenshot_new(self._screenShot, 160, 160, ";simage:")
                # single_string_file_data += utils.add_screenshot(self._screenShot, 200, 200, ";;gimage:")
                single_string_file_data += "\r"
            elif self._screenShot and machineType != "elegoo_neptune_3":
